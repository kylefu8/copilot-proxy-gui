...
const translations = {
  zh: {
    ...
    'model.largeContext': '已检测到 {size} 上下文窗口，将自动追加 [1m] 后缀',
    ...
    'settings.appendLargeContextSuffix': '自动追加 [1m] 后缀',
    'settings.appendLargeContextSuffixTooltip': '开启后，仅当选中的 Claude 模型上下文窗口不小于 1M 时，启动 Claude Code 或写入配置会自动追加 [1m] 后缀。',
    ...
    'update.rollbackTitle': '选择版本',
    'update.rollbackBtn': '回滚',
    'update.rollbackCancel': '取消',
    'update.loadingVersions': '加载版本列表...',
    'update.noVersions': '没有可用的历史版本',
    'update.currentVersion': '（当前）',
    'update.shiftHint': '按住 Shift 点击可回滚到历史版本',
    // ── Risk Dialog ───────────────────────────────
    'risk.title': '⚠️ 使用风险提示',
    'risk.warn1': '警告 1',
  ...
  en: {
    ...
    'model.largeContext': '{size} context window detected, [1m] suffix will be auto-appended',
    ...
    'settings.appendLargeContextSuffix': 'Auto-append [1m] suffix',
    'settings.appendLargeContextSuffixTooltip': 'When enabled, Claude Code launch/config writes append [1m] only if the selected Claude model has a context window of at least 1M.',
    ...
    'update.rollbackTitle': 'Select Version',
    'update.rollbackBtn': 'Rollback',
    'update.rollbackCancel': 'Cancel',
    'update.loadingVersions': 'Loading versions...',
    'update.noVersions': 'No available versions',
    'update.currentVersion': '(current)',
    'update.shiftHint': 'Hold Shift and click to rollback to a previous version',
    // ── Risk Dialog ───────────────────────────────
